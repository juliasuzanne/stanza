...
export const ImageKate = (props) => {
  ...
  useFrame((state, delta) => {
    ...
    myRef.current.position.x += props.speed * 0.05 * Math.sin(state.clock.getElapsedTime());
    // myRef.current.position.y += props.speed * 0.05 * Math.sin(state.clock.getElapsedTime());
  });
